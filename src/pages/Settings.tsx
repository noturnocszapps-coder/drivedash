          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Seus dados estão salvos apenas neste dispositivo.</p>
              </div>
            </div>
        ...
        <Card className="bg-emerald-600 text-white border-none">
          <CardContent className="p-6 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold">Instalar DriverDash</h3>
                <p className="text-xs text-emerald-100">Acesse o app direto da sua tela inicial</p>
              </div>
            </div>
            <Button onClick={handleInstall} className="bg-white text-emerald-600 hover:bg-emerald-50 shrink-0">
              Instalar
            </Button>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            <p className="flex gap-2">
              <span className="w-5 h-5 bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0">1</span>
              <span>Clique no botão "Instalar" acima ou use a opção "Adicionar à tela inicial" no menu do Chrome.</span>
            </p>
            <p className="flex gap-2">
              <span className="w-5 h-5 bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0">2</span>
              <span>O app funcionará offline. Seus dados serão sincronizados automaticamente quando você estiver online.</span>
            </p>
            <p className="flex gap-2">
              <span className="w-5 h-5 bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0">3</span>
              <span>Para melhor experiência, use o Google Chrome no seu Android.</span>
            </p>
          </div>
        </CardContent>
      </Card>
