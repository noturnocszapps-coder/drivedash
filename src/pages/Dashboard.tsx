          ...
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 dark:text-amber-500 mt-1">
                As chaves do Supabase não foram configuradas. O app funcionará apenas em modo offline (Visitante). 
                Para habilitar a sincronização em nuvem, configure as variáveis de ambiente <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">VITE_SUPABASE_URL</code> e <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">VITE_SUPABASE_ANON_KEY</code> no menu de configurações da plataforma.
              </p>
            </div>
          </CardContent>
        </Card>
