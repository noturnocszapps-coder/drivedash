      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <h2 className="text-4xl font-bold mb-6">Feito para o seu celular.</h2>
            <p className="text-lg text-zinc-500 mb-8">
              O DriverDash foi desenhado para ser usado entre uma corrida e outra. 
              Interface rápida, intuitiva e que funciona offline.
            </p>
